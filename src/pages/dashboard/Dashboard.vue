      ...
      <q-card-section class="q-pa-none">
        <q-table :data="data" :columns="columns" hide-bottom>
          ...
          <template v-slot:body-cell-Action="props">
            <q-td :props="props">
              <q-btn icon="edit" size="sm" flat dense @click="clickEdit(props.row)" />
...
<script>
    export default {
        ...
        data() {
            return {
                columns: [
                    {name: 'nr', label: 'Project#', field: 'nr', sortable: true, align: 'left'},
                    ...
                    {name: 'pm', label: 'PM', field: 'pm', sortable: true, align: 'left'},
                    {name: 'state', label: 'State', field: 'Action', sortable: false, align: 'center'},
